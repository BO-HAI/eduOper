...
if (!window.console) {
    (function (win) {
        var consoleModel = {}, names = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "inif", "log", "notifyFirebug", "profile", "profileEnd", "table", "time", "timeEnd", "trace", "warn"], i, len;
...
edu.config = {
    ...
    project: {
        ...
        //后台管理
        manage: {
            domain: "http://manage.edu24ol.com",
            testDomain: "http://manage.hq.com"
        }
    },
    oldTicket: "Passport",
    //旧passport名称
